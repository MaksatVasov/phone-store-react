...
export default function OrderPage() {
    ...
    return (
        <main className="flex-1 container mx-auto max-w-330">
            {!isSuccess ? (
                <form onSubmit={handleSubmit} className="p-4 flex flex-col min-[43.6875rem]:flex-row min-[43.6875rem]:gap-6 bg-white min-[43.6875rem]:bg-transparent">
                    ...
                    <div className="w-full flex flex-col mb-3 min-[43.6875rem]:mb-0 min-[43.6875rem]:bg-white min-[43.6875rem]:p-6 min-[43.6875rem]:rounded-[30px] min-[43.6875rem]:flex-1">
                        ...
                        <div className="flex flex-col mb-4 min-[43.6875rem]:hidden">
                            ...
                            <div className="flex">
                                ...
                                <p className="cart-order-sum-mob ml-auto font-medium m-0">{cartSum} TMT </p>
                            </div>
                        </div>
                    ...
                    <div className="w-full min-[43.6875rem]:flex-1">
                        <div className="hidden min-[43.6875rem]:block bg-white p-6 rounded-[30px] mb-4">
                            ...
                            <div className="flex flex-col gap-3">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <span className="font-medium cart-order-sum">{cartSum} TMT</span>
                                </div>
                                <div className="flex justify-between">
                        ...
                        <button type="submit" className="hidden min-[43.6875rem]:flex justify-center bg-black text-white w-full items-center p-5 rounded-[15px] hover:bg-gray-800 transition-colors">
                            <span>Оформление заказа</span>
                        </button>
                    </div>

                    <div className="p-3 min-[43.6875rem]:hidden w-full">
                        <button type="submit" className="flex justify-center bg-black text-white w-full items-center p-5 rounded-[15px] hover:bg-gray-800 transition-colors border-none">
                            <span className="text-center">Разместить заказ</span>
                        </button>
                    </div>
                </form>
            ) : (
                <div className="flex-col flex-1 h-full mt-10 min-[43.6875rem]:mt-0 flex">
