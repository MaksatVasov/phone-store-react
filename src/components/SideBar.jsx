...
export default function Sidebar() {
    ...
    const { sidebar, setSidebar, isListOpened, setOpen } = useSideBarState();
            ...
            <div className="flex flex-col p-4 h-full">
                ...
                <nav className=" flex flex-col">
                    <span className="flex items-center wishlist mb-2">
                        <a href="wishlist.html" className="no-underline text-black text-base flex items-center gap-2 nav-link">
                    ...
                    <span className="flex items-center gap-2 mb-2">
                        <a href="terms.html" className="no-underline text-black text-base flex items-center gap-2 nav-link">
                    ...
                    <span className="flex items-center gap-2 mb-2">
                        <a href="#!" className="no-underline text-black text-base flex items-center gap-2 nav-link">
