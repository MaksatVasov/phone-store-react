                ...
                <div className="flex gap-6 items-center">
                    ...
                    <div className="relative hidden lg:block">
                        <button
                            ...
                            className={`flex items-center gap-1 text-[1rem] after:transition-transform after:duration-200 after:content-[''] after:inline-block after:w-2 
                                    after:h-1 after:bg-menu-arrow ${isListOpened ? "after:rotate-180" : "after:rotate-0"}`}
                            type="button"
                        >
                ...
                <div className="flex gap-6 justify-between items-center">
                    <div className="relative">
                        ...
                        <div
                            ...
                            className={`${(isFocused && searchInput.trim().length > 0) ? "block" : "hidden"} w-full absolute top-full bg-[rgba(234,234,234,0.9)] 
                            border border-[rgba(194,189,189,0.9)] border-t-0 max-h-100 overflow-y-auto z-2000`}
                        >
